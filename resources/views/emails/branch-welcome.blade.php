...
<head>
    <style>
        ...
        .brand-bar { background: linear-gradient(90deg, #1d4ed8, #0ea5e9); padding: 16px 24px; display: flex; align-items: center; gap: 12px; color: #ffffff; }
            ...
            <div class="inner">
                <div class="content">
                    ...
                    <p style="margin:0 0 12px 0;">
                        Your <strong>Branch account</strong> has been successfully created.
                    </p>

                    <p style="margin:0 0 12px 0;">
                        You can now manage branch operations, handle transactions, and coordinate with headquarters.
                    </p>
                    ...
                    <p style="margin:0 0 12px 0;">
                        Please ensure you update your password after logging in.
                    </p>
