...
<head>
    <style>
        ...
        .brand-bar { background: linear-gradient(90deg, #0f766e, #0ea5e9); padding: 16px 24px; display: flex; align-items: center; gap: 12px; color: #ffffff; }
            ...
            <div class="inner">
                <div class="content">
                    ...
                    <p style="margin:0 0 12px 0;">
                        We are pleased to inform you that your <strong>Headquarters account</strong> has been successfully created.
                    </p>

                    <p style="margin:0 0 12px 0;">
                        You now have full access to oversee operations, manage branches, and monitor system activities.
                    </p>
