...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Congratulations! Your Annex account has been successfully created on <strong>KEDI</strong>.</p>
        </div>
        ...
        <div class="content">
            ...
            <ul>
                <li>Your Annex details will be reviewed by our team.</li>
                <li>Once approved, your Annex will become fully active and accessible on the platform.</li>
                <li>If additional information is required, we will contact you via this email address.</li>
            </ul>

            <h3>Need Assistance?</h3>
            <p>
                If you experience any issues logging in or updating your profile, please contact our support team:<br>
                📧 support@kedi.org<br>
                🌐 {{ config('app.url') }}
            </p>

            <p>We are pleased to have you onboard and look forward to working with you.</p>
        </div>
