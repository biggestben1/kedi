...
<head>
    <style>
        ...
        .brand-bar { background: linear-gradient(90deg, #7c3aed, #0ea5e9); padding: 16px 24px; display: flex; align-items: center; gap: 12px; color: #ffffff; }
            ...
            <div class="inner">
                <div class="content">
                    ...
                    <p style="margin:0 0 12px 0;">
                        Congratulations! Your Distributor account has been successfully created.
                    </p>

                    <p style="margin:0 0 12px 0;">
                        You can now manage branches and oversee operations under your assigned region.
                    </p>

                    <h3 style="margin:0 0 8px 0; font-size:16px; font-weight:600; color:#0f172a;">Login Details</h3>
