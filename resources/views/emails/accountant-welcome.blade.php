...
<head>
    <style>
        ...
        .brand-bar { background: linear-gradient(90deg, #16a34a, #0ea5e9); padding: 16px 24px; display: flex; align-items: center; gap: 12px; color: #ffffff; }
            ...
            <div class="inner">
                <div class="content">
                    ...
                    <p style="margin:0 0 12px 0;">
                        We are pleased to grant you access as an <strong>Accountant</strong> on the system.
                    </p>

                    <p style="margin:0 0 12px 0;">
                        You will be responsible for managing financial records, transactions, and reports.
                    </p>
