...
@section('content')
    ...
    <div class="card">
        <div class="card-header"><h3 class="card-title">Purchase Invoice</h3></div>
        <div class="card-body">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-4">
                        ...
                        @if($suppliers->isEmpty())
                            <small class="text-muted"><a href="{{ route('admin.suppliers.create') }}">Add a supplier</a> first.</small>
                        @endif
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="purchase_invoice" class="form-control" value="{{ old('purchase_invoice') }}" placeholder="Optional">
                    ...
                    <table class="table table-bordered" id="purchase-items-table">
                        ...
                        <tbody id="purchase-items-tbody">
                            <tr class="purchase-item-row">
                                ...
                                <td><input type="number" name="items[0][cost_price]" class="form-control form-control-sm" step="0.01" min="0" value="0" required></td>
