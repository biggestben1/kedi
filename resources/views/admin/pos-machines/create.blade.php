...
@section('title', 'Add POS Machine')

@section('content')
    <div class="page-header">
        <h1 class="page-title">Add POS Machine</h1>
        <div>
            <ol class="breadcrumb">
    ...
    <div class="card">
        <div class="card-header"><h3 class="card-title">New POS Machine</h3></div>
        <div class="card-body">
            <form method="POST" action="{{ route('admin.pos-machines.store') }}" class="row g-3">
                @csrf
                ...
                <div class="col-12">
                    <button type="submit" class="btn btn-primary">Save POS Machine</button>
