@php
    ...
    $customerMenuActive = $customerMenuActive ?? '';
@endphp
<!doctype html>
                ...
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        ...
                        <div class="main-header-center ms-3 d-none d-lg-block">
                            ...
                            <a href="{{ route('blog.index') }}" class="btn btn-outline-secondary btn-sm ms-1">Community blog</a>
                        </div>
                        <div class="d-flex order-lg-2 ms-auto header-right-icons">
                            <button class="navbar-toggler navresponsive-toggler d-lg-none ms-auto" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent-customer" aria-controls="navbarSupportedContent-customer" aria-expanded="false" aria-label="Toggle navigation">
                                <span class="navbar-toggler-icon fe fe-more-vertical"></span>
                            </button>
                            <div class="navbar navbar-collapse responsive-navbar p-0">
                                <div class="collapse navbar-collapse" id="navbarSupportedContent-customer">
                                    <div class="d-flex order-lg-2">
                                        ...
                                        <div class="dropdown d-flex profile-1">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                ...
                                                @php
                                                    $hdrRole = auth()->user()->role?->name;
                                                    $hdrAdminLabel = match($hdrRole) {
                                                        'reseller' => 'Reseller',
                                                ...
                                                @endphp
                                                <a class="dropdown-item" href="{{ in_array($hdrRole, ['headquarters', 'branch', 'service_center', 'annex']) ? route('admin.pharmacy.dashboard') : route('admin') }}"><i class="dropdown-icon fe fe-settings"></i> {{ $hdrAdminLabel }}</a>
                                                @endif
            ...
            <div class="sticky">
                ...
                <div class="app-sidebar">
                    ...
                    <div class="main-sidemenu">
                        ...
                        @include('partials.customer-sidebar', ['active' => $customerMenuActive])
